...
public class Materials extends Material {
	...
	public final static int POLISHED_COPPER = 4;
	...
	public Materials(int type) {
		...
		case POLISHED_COPPER:
			this.setAmbientColor(0.2295f, 0.08825f, 0.0275f);
			this.setDiffuseColor(0.5508f, 0.2118f, 0.066f);
			this.setSpecularColor(0.580594f, 0.223257f, 0.0695701f);
			this.setShininess(51.2f);
			break;
		}
	}
